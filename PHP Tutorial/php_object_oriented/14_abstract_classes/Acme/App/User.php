 ...
 */
 namespace Acme\App;
 /**
  * Abstract class like a partial class
  * @author BISWAJIT
  *
  */
abstract class User{
    ...
    */
     ...
     * @var array
     */
    protected  $accessiable = array('email','password');
     ...
     * Log in a user
     * @return string
     * Abstract method have not a body and implement only in chield class method.
     */
